...
products:
- azure
description: "These code samples will show you how to manage Service Fabric Application using Azure SDK for Golang."
urlFragment: service-fabric-applications
---

# Getting started - Managing Service Fabric Application using Azure Golang SDK

These code samples will show you how to manage Service Fabric Application using Azure SDK for Golang.
