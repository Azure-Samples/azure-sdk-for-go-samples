...
products:
- azure
description: "These code samples will show you how to manage Compute Snapshot using Azure SDK for Golang."
urlFragment: compute-snapshot
---

# Getting started - Managing Compute Snapshot using Azure Golang SDK

These code samples will show you how to manage Compute Snapshot using Azure SDK for Golang.
