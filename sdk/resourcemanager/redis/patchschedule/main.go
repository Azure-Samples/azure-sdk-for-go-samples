...
var (
	...
	patchSchedulesClient  *armredis.PatchSchedulesClient
)
...
func main() {
	...
	patchSchedulesClient = redisClientFactory.NewPatchSchedulesClient()
	...
	patch, err := createPatchSchedule(ctx)
	if err != nil {
		log.Fatal(err)
	}
...
func createPatchSchedule(ctx context.Context) (*armredis.PatchSchedule, error) {
