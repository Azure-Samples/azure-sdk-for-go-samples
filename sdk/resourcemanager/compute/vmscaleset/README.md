...
products:
- azure
description: "These code samples will show you how to manage Compute Scale Set using Azure SDK for Golang."
urlFragment: compute-vm-scaleset
---

# Getting started - Managing Compute Scale Set using Azure Golang SDK

These code samples will show you how to manage Compute Scale Set using Azure SDK for Golang.
