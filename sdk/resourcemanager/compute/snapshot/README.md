...
products:
- azure
description: "These code samples will show you how to manage Snapshot resource of Compute service using Azure SDK for Golang."
urlFragment: compute-snapshot
---

# Getting started - Managing Snapshot resource of Compute service using Azure Golang SDK

These code samples will show you how to manage Snapshot resource of Compute service using Azure SDK for Golang.
