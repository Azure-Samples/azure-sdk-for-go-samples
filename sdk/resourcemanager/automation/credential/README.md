...
products:
- azure
description: "These code samples will show you how to manage Credential resource of Automation service using Azure SDK for Golang."
urlFragment: automation-credential
---

# Getting started - Managing Credential resource of Automation service using Azure Golang SDK

These code samples will show you how to manage Credential resource of Automation service using Azure SDK for Golang.
