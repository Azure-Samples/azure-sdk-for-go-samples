...
products:
- azure
description: "These code samples will show you how to manage Token resource of Container Registry service using Azure SDK for Golang."
urlFragment: container-registry-token
---

# Getting started - Managing Token resource of Container Registry service using Azure Golang SDK

These code samples will show you how to manage Token resource of Container Registry service using Azure SDK for Golang.
