...
products:
- azure
description: "These code samples will show you how to manage Topic resource of Event Grid service using Azure SDK for Golang."
urlFragment: event-grid-topic
---

# Getting started - Managing Topic resource of Event Grid service using Azure Golang SDK

These code samples will show you how to manage Topic resource of Event Grid service using Azure SDK for Golang.
