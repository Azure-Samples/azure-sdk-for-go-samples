...
products:
- azure
description: "These code samples will show you how to manage Module resource of Automation service using Azure SDK for Golang."
urlFragment: automation-module
---

# Getting started - Managing Module resource of Automation service using Azure Golang SDK

These code samples will show you how to manage Module resource of Automation service using Azure SDK for Golang.
