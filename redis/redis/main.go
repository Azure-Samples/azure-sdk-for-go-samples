...
func getRedis(ctx context.Context, cred azcore.TokenCredential) (r armredis.RedisGetResponse, err error) {
	redisClient := armredis.NewRedisClient(subscriptionID, cred, nil)
...
func updateRedis(ctx context.Context, cred azcore.TokenCredential) (r armredis.RedisUpdateResponse, err error) {
	redisClient := armredis.NewRedisClient(subscriptionID, cred, nil)
