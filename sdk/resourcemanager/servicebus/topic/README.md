...
products:
- azure
description: "These code samples will show you how to manage Topic resource of Service Bus service using Azure SDK for Golang."
urlFragment: servicebus
---

# Getting started - Managing Topic resource of Service Bus service using Azure Golang SDK

These code samples will show you how to manage Topic resource of Service Bus service using Azure SDK for Golang.
