...
products:
- azure
description: "These code samples will show you how to manage Automation Module using Azure SDK for Golang."
urlFragment: automation-module
---

# Getting started - Managing Automation Module using Azure Golang SDK

These code samples will show you how to manage Automation Module using Azure SDK for Golang.
