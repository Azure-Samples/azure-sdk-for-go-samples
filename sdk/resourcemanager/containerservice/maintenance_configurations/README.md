...
products:
- azure
description: "These code samples will show you how to manage Maintenance Configurations resource of Container Service service using Azure SDK for Golang."
urlFragment: container-service-maintenance
---

# Getting started - Managing Maintenance Configurations resource of Container Service service using Azure Golang SDK

These code samples will show you how to manage Maintenance Configurations resource of Container Service service using Azure SDK for Golang.
