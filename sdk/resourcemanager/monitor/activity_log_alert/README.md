...
products:
- azure
description: "These code samples will show you how to manage Monitor Activity Log Alert using Azure SDK for Golang."
urlFragment: monitor-activity-log-alert
---

# Getting started - Managing Monitor Activity Log Alert using Azure Golang SDK

These code samples will show you how to manage Monitor Activity Log Alert using Azure SDK for Golang.
