...
products:
- azure
description: "These code samples will show you how to manage Automation Variable using Azure SDK for Golang."
urlFragment: automation-variable
---

# Getting started - Managing Automation Variable using Azure Golang SDK

These code samples will show you how to manage Automation Variable using Azure SDK for Golang.
