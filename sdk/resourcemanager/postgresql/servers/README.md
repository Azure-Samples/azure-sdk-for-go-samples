...
products:
- azure
description: "These code samples will show you how to manage Server resource of Database for PostgreSQL service using Azure SDK for Golang."
urlFragment: postgresql-servers
---

# Getting started - Managing Server resource of Database for PostgreSQL service using Azure Golang SDK

These code samples will show you how to manage Server resource of Database for PostgreSQL service using Azure SDK for Golang.
