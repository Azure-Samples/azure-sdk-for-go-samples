...
products:
- azure
description: "These code samples will show you how to manage Database for MySQL Server using Azure SDK for Golang."
urlFragment: mysql-server
---

# Getting started - Managing Database for MySQL Server using Azure Golang SDK

These code samples will show you how to manage Database for MySQL Server using Azure SDK for Golang.
