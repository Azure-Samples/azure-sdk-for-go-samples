...
func createFireWallRule(ctx context.Context, conn *arm.Connection) (r armredis.FirewallRulesCreateOrUpdateResponse, err error) {
	firewallRulesClient := armredis.NewFirewallRulesClient(conn, subscriptionID)
