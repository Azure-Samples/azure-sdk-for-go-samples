...
products:
- azure
description: "These code samples will show you how to manage Agent Pool resource of Container Service service using Azure SDK for Golang."
urlFragment: container-service-agent-pool
---

# Getting started - Managing Agent Pool resource of Container Service service using Azure Golang SDK

These code samples will show you how to manage Agent Pool resource of Container Service service using Azure SDK for Golang.
