...
products:
- azure
description: "These code samples will show you how to manage API Policy using Azure SDK for Golang."
urlFragment: api-policy
---

# Getting started - Managing API Policy using Azure Golang SDK

These code samples will show you how to manage API Policy using Azure SDK for Golang.
