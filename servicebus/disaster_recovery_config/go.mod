module azure-sdk-for-go-samples/servicebus/disasterrecoveryconfig
...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/servicebus/armservicebus v0.1.0
)
