...
products:
- azure
description: "These code samples will show you how to manage Virtual Network Link resource of PrivateDNS service using Azure SDK for Golang."
urlFragment: private-dns-vnet-link
---

# Getting started - Managing Virtual Network Link resource of PrivateDNS service using Azure Golang SDK

These code samples will show you how to manage Virtual Network Link resource of PrivateDNS service using Azure SDK for Golang.
