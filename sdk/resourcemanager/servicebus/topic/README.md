...
products:
- azure
description: "These code samples will show you how to manage Service Bus Topic using Azure SDK for Golang."
urlFragment: servicebus
---

# Getting started - Managing Service Bus Topic using Azure Golang SDK

These code samples will show you how to manage Service Bus Topic using Azure SDK for Golang.
