...
products:
- azure
description: "These code samples will show you how to manage Security Groups resource of Virtual Network service using Azure SDK for Golang."
urlFragment: network-security-groups
---

# Getting started - Managing Security Groups resource of Virtual Network service using Azure Golang SDK

These code samples will show you how to manage Security Groups resource of Virtual Network service using Azure SDK for Golang.
