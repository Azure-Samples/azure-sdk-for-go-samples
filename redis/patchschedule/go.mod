module github.com/Azure-Samples/azure-sdk-for-go-samples/redis/patchschedule
...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/redis/armredis v0.2.0
