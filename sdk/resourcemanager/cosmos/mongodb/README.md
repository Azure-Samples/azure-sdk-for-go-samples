...
products:
- azure
description: "These code samples will show you how to manage Cosmos DB Mongo using Azure SDK for Golang."
urlFragment: cosmos-mongo-db
---

# Getting started - Managing Cosmos DB Mongo using Azure Golang SDK

These code samples will show you how to manage Cosmos DB Mongo using Azure SDK for Golang.
