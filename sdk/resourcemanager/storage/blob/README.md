...
products:
- azure
description: "These code samples will show you how to manage Blob resource of Storage service using Azure SDK for Golang."
urlFragment: storage-blob
---

# Getting started - Managing Blob resource of Storage service using Azure Golang SDK

These code samples will show you how to manage Blob resource of Storage service using Azure SDK for Golang.
