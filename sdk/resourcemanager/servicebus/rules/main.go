...
var (
	...
	rulesClient         *armservicebus.RulesClient
)
...
func main() {
	...
	rulesClient = servicebusClientFactory.NewRulesClient()
	...
	rules, err := createRules(ctx)
	if err != nil {
		log.Fatal(err)
	}
	log.Println("rules:", *rules.ID)
...
func createRules(ctx context.Context) (*armservicebus.Rule, error) {
