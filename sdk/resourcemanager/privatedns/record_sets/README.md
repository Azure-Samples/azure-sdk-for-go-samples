...
products:
- azure
description: "These code samples will show you how to manage Record Sets resource of PrivateDNS service using Azure SDK for Golang."
urlFragment: private-dns-record-sets
---

# Getting started - Managing Record Sets resource of PrivateDNS service using Azure Golang SDK

These code samples will show you how to manage Record Sets resource of PrivateDNS service using Azure SDK for Golang.
