...
products:
- azure
description: "These code samples will show you how to manage Database for PostgreSQL Firewall Rule using Azure SDK for Golang."
urlFragment: postgresql-firewall-rule
---

# Getting started - Managing Database for PostgreSQL Firewall Rule using Azure Golang SDK

These code samples will show you how to manage Database for PostgreSQL Firewall Rule using Azure SDK for Golang.
