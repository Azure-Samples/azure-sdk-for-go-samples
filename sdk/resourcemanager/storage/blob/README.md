...
products:
- azure
description: "These code samples will show you how to manage Storage Blob using Azure SDK for Golang."
urlFragment: storage-blob
---

# Getting started - Managing Storage Blob using Azure Golang SDK

These code samples will show you how to manage Storage Blob using Azure SDK for Golang.
